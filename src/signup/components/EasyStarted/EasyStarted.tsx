  ...
  return (
    <div class={css.root}>
      <div class={css.content}>
        ...
        <ul class={css.list}>
          <li class={css.item}>
            <img src={img1} alt="" width="32" height="32" class={css.icon} />
          ...
          <li class={css.item}>
            <img src={img4} alt="" width="32" height="32" class={css.icon} />
