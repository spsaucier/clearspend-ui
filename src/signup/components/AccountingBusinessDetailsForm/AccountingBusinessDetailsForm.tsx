...
import css from './AccountingBusinessDetailsForm.css';

interface AccountingBusinessDetailsFormValues {
...
interface AccountingBusinessDetailsFormProps {
  onNext: (
    businessTypeCategory: BusinessTypeCategory,
    businessType: BusinessType,
    isOwnerOf25?: boolean,
...
export function AccountingBusinessDetailsForm(props: Readonly<AccountingBusinessDetailsFormProps>) {
  const { values, errors, handlers, wrapSubmit } = createForm<AccountingBusinessDetailsFormValues>({
    defaultValues: {
  ...
  const onSubmit = (data: Readonly<AccountingBusinessDetailsFormValues>) => {
    props.onNext(
  ...
  const disableNext = (v: AccountingBusinessDetailsFormValues) => {
